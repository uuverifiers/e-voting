...
type PreferenceList = seq<Candidate> 
type Votes_PreferenceList = seq<PreferenceList>
...
type Tuple = (Votes_PreferenceList, FactorList)
type Indices = seq<nat>
type Triple = (Votes_PreferenceList, FactorList, Candidates)


predicate ValidInputs(V : Votes_PreferenceList, C : Candidates)
...
predicate ValidInputsSTV(V : Votes_PreferenceList, C : Candidates)
//defines valid inputs for the list of votes and candidates
{
    (0 < |C|) &&
...
lemma V_Uniqueness(V : Votes_PreferenceList)
