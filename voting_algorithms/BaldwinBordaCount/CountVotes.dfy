...
function getScore(V : Votes_PreferenceList, C : Candidates, c : Candidate) :(result : nat)
    ...
    Input:
        V (Votes_PreferenceList) : sequence of preference lists given by voters
...
method countVotes(V : Votes_PreferenceList, C : Candidates) returns (R : Ranking)
